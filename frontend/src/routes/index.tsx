  ...
  const dashboardRoutes = [
    {
      ...
      children: [
        ...
        { path: 'personal', element: <DashboardPage /> },
        { path: 'proyectos', element: <DashboardPage /> },
        { path: 'servicios', element: <DashboardPage /> },
        { path: 'publicaciones', element: <DashboardPage /> },
        { path: 'blog', element: <DashboardPage /> }
      ]
    },
